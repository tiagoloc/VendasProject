  ...
  case FAcaoTela of
    tacCadastroPedido:
      begin
        ...
        lblFiltro.Caption := 'Cliente:';

        btnConsultarFiltro.Enabled := False;
        btnAcaoPedido.Enabled := True;

        btnAdicionarProduto.Caption := 'ADICIONAR PRODUTO';
        btnConsultarFiltro.Caption := 'CONSULTAR PEDIDO';
    ...
    tacSelecionarCliente:
      begin
        ...
        pnlListaPedidos.Enabled := False;
        OcultarGridPesquisa;
        btnConsultarFiltro.Enabled := True;
        btnAcaoPedido.Enabled := False;
    ...
    tacSelecionarPedido:
      begin
        ...
        lblFiltro.Caption := 'Pedido:';
        edtFiltro.Color := clInfoBk;

        btnAdicionarProduto.Caption := 'ADICIONAR PRODUTO';
        btnConsultarFiltro.Caption := 'CONSULTAR CLIENTE';
